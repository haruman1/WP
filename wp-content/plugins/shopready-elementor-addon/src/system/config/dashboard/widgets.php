<?php
  ...
  'progressbar_woo_ready_progress_roadmap' => [

    'title'         => esc_html__('Progress Roadmap','shopready-elementor-addon'),
    'icon'          => 'eicon-time-line',
    'show_in_panel' => false,
    'is_pro'        => true,
    'dashboard'     => 'yes',
    'category'      => [ 'wgenerel' ],
    'keywords'      => [ 'Timeline Progeress', 'Progress', 'Roadmap', 'Timeline' ],
    'css'           => [
      'woo-ready-extra-widgets-base','roadmap'
    ],

    'js' => [
      'woo-ready-extra-widgets','roadmap'
    ]
  ],
