                ...
                <div class="woo-ready-component-form-wrapper modules">
                    <div class="woo-ready-components-topbar">
                        <div class="woo-ready-title">
                            <h3 class="title"><i class="dashicons dashicons-arrow-left-alt woo-ready-offcanvas"></i> <?php echo esc_html($heading); echo '( '.$total_modules .' )'; ?></h3>
                        </div>
                        <div class="woo-ready-savechanges">
                            <div class="woo-ready-admin-search">
                                <input data-target="<?php echo esc_attr($switch_js_target); ?>" placeholder="<?php echo esc_attr__( 'Search here', 'shopready-elementor-addon' ) ?>" class="quomodo_text woo-ready-element-search" id="woo-ready-module-search" type="search">
                            </div>
                            ...
                            <div class="woo-ready-check-all">
                                <div class="quomodo_switch_common woo-ready-common">
                                    <div data-target="<?php echo esc_attr($switch_js_target); ?>" class="quomodo_sm_switch woo-ready-disable-all-switch" id="quomodo-components-all-disable">
                                        <strong>
                    ...
                    <div class="quomodo-container">
                        <div class="quomodo-row woo-ready-component-row">
                            ...
                            <div class="woo-ready-col quomodo-col-xl-3 quomodo-col-lg-3 quomodo-col-md-5 <?php echo esc_attr($item['is_pro']?'shop-ready-pro-orde':''); ?>">
                                <div class="quomodo_switch_common woo-ready-common <?php echo esc_attr($item['is_pro']?'woo-ready-pro woo-ready-dash-modal-open-btn':''); ?>">
                                
                                    <div data-targetee="<?php echo esc_attr($switch_js_target); ?>" class="quomodo_sm_switch">
                                        <?php if(isset($item['demo_link']) && $item['demo_link'] !=''): ?>
                                        <a target="_blank" href="<?php echo esc_url($item['demo_link']); ?>" class="woo-ready-data-tooltip"><?php echo esc_html__('view demo','shopready-elementor-addon'); ?></a>
                                        <?php endif; ?>
                                        <strong><?php echo esc_html($item['lavel']); ?>
                                            <?php if($item['is_pro']): ?>
                                                <span> <?php echo isset($item['upcomming']) ? esc_html__( 'Upcomming', 'shopready-elementor-addon' ) : esc_html__( 'PRO', 'shopready-elementor-addon' ) ?> </span>
                                            <?php endif; ?>    
                                        </strong>
                                        <input <?php echo esc_attr($item['is_pro']?'readonly disabled':''); ?> <?php echo esc_attr($item['default']==1?'checked':''); ?> name="<?php echo esc_attr( $option_key ); ?>[<?php echo sanitize_key($item_key); ?>]" class="quomodo_switch <?php echo esc_attr($item_key); ?>" id="<?php echo esc_attr($label_identifier); ?><?php echo sanitize_key($item_key); ?>" type="checkbox">
                                        <label for="<?php echo sanitize_key($label_identifier); ?><?php echo sanitize_key($item_key); ?>"></label>
                                    </div>
                                </div>
                            </div>
                            <?php endforeach; ?>
