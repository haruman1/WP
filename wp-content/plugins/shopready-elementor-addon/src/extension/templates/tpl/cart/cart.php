...
<?php do_action( 'woocommerce_before_cart' ); ?>
	...
	<div class="shop-ready-cart-inner-container <?php echo esc_attr($page_layout); ?> <?php echo esc_attr($page_layout=='style3'?'display:flex flex-direction:column':''); ?>">
						...
						if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
							...
							<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
								...
								<td class="product-thumbnail">
									...
									?>
										<div class="product-name" data-title="<?php esc_attr_e( 'Product', 'shopready-elementor-addon' ); ?>">
											<?php
					...
					<tr>
						<td colspan="6" class="actions">
							...
							<?php if ( wc_coupons_enabled() ) { ?>
								<div class="coupon">
									<label for="coupon_code"><?php echo esc_html($coupon_label); ?></label> <input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php echo esc_html($apply_code_label); ?>" /> <button type="submit" class="button" name="apply_coupon" value="<?php echo esc_html($apply_coupon_label); ?>"><?php echo esc_html($apply_coupon_label); ?></button>
									<?php do_action( 'woocommerce_cart_coupon' ); ?>
								</div>
							<?php } ?>

							<button type="submit" class="button" name="update_cart" value="<?php echo esc_attr($update_cart); ?>"><?php echo esc_html($update_cart); ?></button>
				...
				<tbody>
					...
					<tr>
						<td colspan="6" class="actions">
							...
							<?php if ( wc_coupons_enabled() ) { ?>
								<div class="coupon">
									<label for="coupon_code"><?php esc_html_e( 'Coupon:', 'shopready-elementor-addon' ); ?></label> <input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'shopready-elementor-addon' ); ?>" /> <button type="submit" class="button" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'shopready-elementor-addon' ); ?>"><?php esc_attr_e( 'Apply coupon', 'shopready-elementor-addon' ); ?></button>
									<?php do_action( 'woocommerce_cart_coupon' ); ?>
								</div>
							<?php } ?>
				...
				<tbody>
						...
						if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
							...
							<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
								...
								<td class="product-thumbnail shop-ready-pro-style3">
									...
									?>
										<div class="product-name shop-ready-pro-style3" data-title="<?php esc_attr_e( 'Product', 'shopready-elementor-addon' ); ?>">
											<?php
												if ( ! $product_permalink ) {
													echo wp_kses_post( apply_filters( 'woocommerce_cart_item_name', $_product->get_name(), $cart_item, $cart_item_key ) . '&nbsp;' );
												} else {
					...
					<tr>
						<td colspan="6" class="actions">
							...
							<?php if ( wc_coupons_enabled() ) { ?>
								<div class="coupon">
									<label for="coupon_code"><?php echo esc_html($coupon_label); ?></label> <input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php echo esc_attr($apply_code_label); ?>" /> <button type="submit" class="button" name="apply_coupon" value="<?php echo esc_attr( $apply_coupon_label ); ?>"><?php echo esc_html( $apply_coupon_label ); ?></button>
									<?php do_action( 'woocommerce_cart_coupon' ); ?>
								</div>
							<?php } ?>
