...
return [
   ...
   'comming_soon' => [
     ...
     'vendor' => [
          ...
          '_shop_ready_product_vendor_name' => [ 
               'id'            => '_shop_ready_product_vendor_name', 
               'wrapper_class' => '', 
               'label'         => __('Vendor Name', 'shopready-elementor-addon' ), 
               'description'   => __( 'Product Owner', 'shopready-elementor-addon' ) 
           ]
