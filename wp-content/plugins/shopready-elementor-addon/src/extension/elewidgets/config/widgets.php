    ...
    **************** *************/
    ...
    $return_component = [
            ...
            'shop_sr_deals_products_counter' => [
                ...
                'js'            => [
                    'owl-carousel','woo-ready-extra-widgets' 
                 ],
            ...
            'shop_sidebar_search_form' => [
                ...
                'js'            => [
                   'nice-select','mangocube-elementor-base'
                ],
                'css' => ['nice-select','mangocube-elementor-base','woo-ready-extra-widgets-base']
            ],
            ...
            'shop_shop_ready_sidebar_cart' => [
                ...
                'js'            => [
                   'woo-ready-extra-widgets','wp-util'
                ],
            ...
            'checkout_billing_address' => [
                'title'         => esc_html__('Billing Address','shopready-elementor-addon'),
                'icon'          => 'eicon-google-maps',
                'show_in_panel' => false,
                'is_pro'        => true,
                'dashboard'     => 'yes',
                'category'      => ['sready-checkout'],
                'keywords' => [ 'Shop Ready','checkout shipping','checkout','billing','address' ],
                'js' => [
                    'jquery','shop-ready-checkout'
                ]
            ],
            
            'checkout_multi_step_form' => [
                'title'         => esc_html__('Checkout Multi Step','shopready-elementor-addon'),
                'icon'          => 'eicon-edit',
                'show_in_panel' => false,
                'is_pro'        => true,
                'dashboard'     => 'yes',
                'category'      => ['sready-checkout'],
                'keywords' => [ 'Shop Ready','checkout','multi step','muti step checkout','checkout muti step' ],
                'js' => [
                    'jquery','shop-ready-checkout'
                ]
            ],
            ...
            'cart_shortcode' => [
                'title'         => esc_html__('Cart ShortCode','shopready-elementor-addon'),
            ...
            'shop_result_count' => [
                'title'         => esc_html__('Shop Result Count','shopready-elementor-addon'),
                'icon'          => 'eicon-gallery-grid',
                'show_in_panel' => false,
                'is_pro'        => false,
                'dashboard'     => 'yes',
                'category'      => [ 'shopready-elementor-addon' ],
                'keywords'      => [ 'shop','shop ready', 'result count' ],
               
            ], 
            
            'shop_catelog_ordering' => [
                'title'         => esc_html__('Shop Catelog Ordering','shopready-elementor-addon'),
                'icon'          => 'eicon-gallery-grid',
                'show_in_panel' => false,
                'is_pro'        => false,
                'dashboard'     => 'yes',
                'category'      => [ 'shopready-elementor-addon' ],
                'keywords'      => [ 'shop','shop ready', 'Catelog Order' ],
            ...
            'product_upsell' => [
                ...
                'css'            => [
                    'woocommerce-general','shop-ready-single-product'
            ...
            'product_sales_schedule' => [
                'title'         => esc_html__('Product Sales Schedule','shopready-elementor-addon'),
                'icon'          => 'eicon-countdown',
                'show_in_panel' => false, 
                'is_pro' => true,
                'dashboard'     => 'yes',
                'category'      => [ 'sready-product' ],
                'keywords'      => [ 'product sales schedule','sales schedule','discount count down' ],
                'js'            => [
                    'jquery','shop-ready-single-product'
                ]
            ],
            ...
            'product_add_to_cart' => [
                ...
                'js'            => [
                    'jquery','shop-ready-single-product','nice-select'
                ],
                'css' => [
                    'nice-select'
                ]
            ...
            'general_countdown_banner' => [
                ...
                'title'         => esc_html__('Countdown Banner','shopready-elementor-addon'),
                'icon'          => 'eicon-countdown',
                'show_in_panel' => false, 
                'is_pro'        => true,
                'dashboard'     => 'yes',
                'category'      => [ 'shopready-elementor-addon' ],
                'keywords'      => [ 'Shop Ready Banner' , 'banner', 'countdown' ],
                'js'            => [ ],
                'css' => [
                    'mangocube-elementor-base'
                ]
            ],
            ...
            'general_tabs' => [
                'title'         => esc_html__('Tabs','shopready-elementor-addon'),
                'icon'          => 'eicon-tabs',
                'show_in_panel' => false, 
                'is_pro'        => false,
                'dashboard'     => 'yes',
            ...
            'general_cart_count' => [
                ...
                'js'            => [
                    'jquery','shop-ready-elementor-base'
                ]
            ], 
            ...
            'general_shop_menu' => [
                'title'         => esc_html__('Shop Navigation','shopready-elementor-addon'),
                'icon'          => 'eicon-nav-menu',
                'show_in_panel' => false, 
                'is_pro'        => true,
                'dashboard'     => 'yes',
                'category'      => [ 'sready-gen' ],
                'keywords'      => [ 'mega menu' , 'navigation' ],
                'js'            => [
