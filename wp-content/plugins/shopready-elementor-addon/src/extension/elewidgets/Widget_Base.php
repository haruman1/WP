...
Abstract Class Widget_Base extends \Elementor\Widget_Base {
	...
	public function get_current_page_url() {
		...
		if ( isset( $_GET['rating_filter'] ) ) {
			$link = add_query_arg( 'rating_filter', wc_clean( wp_unslash( sanitize_text_field($_GET['rating_filter']) ) ), $link );
		}
    ...
    public function render(){
        ...
        try{
            ...
            if($this->wrapper_class){
              echo \sprintf('<div class="%s" >',apply_filters( 'shop_ready_ele_widget_container', 'woo-ready-ele-widget-container' ));
            }
