...
if ( $max_value && $min_value === $max_value ) {
	...
	$label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'shopready-elementor-addon' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'woo-raedy' );
	?>
	<div class="wooready_product_quantity">
		<div class="product-quantity">
			...
			<input
				...
				item_key="<?php echo esc_attr( $item_key ); ?>"
