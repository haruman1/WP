				...
				<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						<td class="product-name">
							...
							<div class="product-title"> <?php echo wp_kses_post( apply_filters( 'woocommerce_cart_item_name', $_product->get_name(), $cart_item, $cart_item_key ) ) . '&nbsp;'; ?> </div>
							 <div class="shop-ready-product-item-qty-wrapper">
								<?php echo apply_filters( 'woo_ready_checkout_cart_item_quantity', ' <strong class="product-quantity">' . sprintf( '&times;&nbsp;%s', esc_html($cart_item['quantity']) ) . '</strong>', $cart_item, $cart_item_key, $order_review_qty_change,$order_review_show_price );  ?>
							</div>
							<?php if($enable_thumbnail == 'yes'): ?>
								<img src="<?php echo esc_url(wp_get_attachment_image_url( $_product->get_image_id(),'thumbnail' )); ?>" class="shop-ready-product-order-review-img" />
							<?php endif; ?>
					...
					<?php else: ?>
						<td class="product-name">
							...
							<div class="product-title"> <?php echo wp_kses_post( apply_filters( 'woocommerce_cart_item_name', esc_html($_product->get_name()), $cart_item, $cart_item_key ) ) . '&nbsp;'; ?> </div>
