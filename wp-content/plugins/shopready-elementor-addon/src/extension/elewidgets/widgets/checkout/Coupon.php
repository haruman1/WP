...
class Coupon extends \Shop_Ready\extension\elewidgets\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->text_wrapper_css(
			[ 
				'title'  => esc_html__('Toggle Content','shopready-elementor-addon'),
		...
		$this->input_field(
			[
				'title'          => esc_html__('Coupon Code','shopready-elementor-addon'),
	   ...
	   $this->box_layout(
			[ 
			'title'        => esc_html__('Coupon Form Container','shopready-elementor-addon'),
