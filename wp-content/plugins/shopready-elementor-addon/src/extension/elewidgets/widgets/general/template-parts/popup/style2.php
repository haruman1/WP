    ...
    <!--====== mini Poup  START ======-->
        <div class="woo-ready-block-header woo-ready-dropdown">
            <a class="woo-ready-user-interface woo-ready-popup" href="javascript:void(0);" data-gnash="gnash-dropdown">
                ...
                <?php endif; ?>
                <?php if($label !=''): ?>
                   <div class="display:inline-block woo-ready-mini-popup-label"> <?php echo esc_html($label); ?> </div> 
                <?php endif; ?>
        ...
        <div class="shop-ready-pro-minipopup-popup-modal margin:20 nifty-modal <?php echo esc_attr($modal_animation); ?>" id="shop-ready-pro-minipopup-popup-modal">
