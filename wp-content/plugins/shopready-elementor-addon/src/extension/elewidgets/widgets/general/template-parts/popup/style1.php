    ...
    <!--====== mini Poup  START ======-->
        <div class="woo-ready-block-header woo-ready-dropdown">
            <div class="woo-ready-user-interface woo-ready-popup">
                ...
                <?php endif; ?>
                <?php if($label !=''): ?>
                   <div class="display:inline-block woo-ready-mini-popup-label shop-ready-mini-popup-label-modifire"> <?php echo esc_html($label); ?> </div> 
                <?php endif; ?>
            ...
            <div class="header-account woo-ready-sub-content <?php echo esc_attr($settings['_kt_entrance_animation']); ?>">
                ...
                <div class="shop-ready-cart-count-close-btn">
                    <?php echo shop_ready_render_icons( $close_icon , 'wready-icons' ); ?>
                </div>
            </div>
        </div>
    <!--======  PopUp END ======-->