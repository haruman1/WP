    ...
    <div class="wooready-slider-product-layout srt---iop">
        <div class="product-thumb">
             <?php echo wp_kses_post($product_image);
               ...
               <div class="discount"><?php echo wp_kses_post($percentage_sale); ?></div>
            <?php } ?>
        </div>
        <div class="product-details">
                    ...
                    <div class="product-vendor-name">
                        <p>
                            <?php if($settings['wooready_products_vendor_text'] !=''): ?>
                                <span> <?php echo esc_html($settings['wooready_products_vendor_text']) ?> </span>   
                            <?php endif; ?>
            ...
            <?php
                ...
                if($product->is_type('variable')){
                    ...
                    echo '<div class="wooready_product_color order:4 display:flex">';
            ...
            ?>
            <a class="add-to-cart" href="<?php echo esc_url($addToCartUrl); ?>"><?php echo wp_kses_post($add_to_cart_icon); ?></a>
        </div>
        <div class="product-meta" >
            <?php
                 ...
                 if( $product->is_purchasable() && $product->is_in_stock() ){
                     ...
                     echo sprintf("<a data-product-type='%s' data-product_id='%s' title='%s' class='wready-product-compare href='#'>", esc_attr( $product->get_type()) , esc_attr( $product->get_id() ), esc_html($compare_text) );
                 ...
                 echo sprintf("<a data-product-type='%s' data-product_id='%s' title='%s' class='wready-product-quickview view' href='#'>", esc_attr($product->get_type()), esc_attr($product->get_id()), esc_html( $_text ));
                 ...
                 echo sprintf("<a data-product-type='%s' data-product_id='%s' title='%s' class='whishlist wready-product-wishlist' href='#'> ",esc_attr($product->get_type()), esc_attr($product->get_id()), esc_html( $_text ));
                   echo wp_kses_post( shop_ready_render_icons( $_icon , 'wready-icons' ) );
                   echo esc_html($_text);
                 echo '</a>';
            ?>
