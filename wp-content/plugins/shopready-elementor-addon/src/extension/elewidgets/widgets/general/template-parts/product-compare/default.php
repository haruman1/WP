...
<div class="woo-ready-productcompare">
    <table>
        ...
        <tr>
            ...
            <th class="emepty-border"><?php echo esc_html($options['title']['title']) ?></th>
            ...
            <td>
                <div class="woo-ready-product-title">
                    <span class="woo-ready-product-name"><?php echo esc_html($product_name); ?></span>
        ...
        <?php endif; if ( $options['image']['image_exist'] ): ?>

        <tr>

            <th><?php echo wp_kses_post($options['image']['title']); ?></th>
        ...
        <?php endif; if ( $options['avalability']['avalability_exist'] ): ?>

        <tr>

            <th><?php echo wp_kses_post($options['avalability']['title']); ?></th>
            ...
            <td>
                <div class="woo-ready-stock">
                    <span><?php echo wp_kses_post($stockStatus); ?></span>
                </div>
            </td>
        ...
        <?php endif; if ( $options['description']['description_exist'] ): ?>

        <tr>

            <th><?php echo wp_kses_post($options['description']['title']) ?></th>
        ...
        <?php endif; if ( $options['color']['color_exist'] ): ?>

        <tr>

            <th><?php echo wp_kses_post($options['color']['title']); ?></th>
            ...
            <td>
                <div class="woo-ready-color">
                    <span><?php echo wp_kses_post($color); ?></span>
                </div>
            </td>
        ...
        <?php endif; if ( $options['sku']['sku_exist'] ): ?>

        <tr>

            <th><?php echo wp_kses_post($options['sku']['title']); ?></th>
            ...
            <td>
                <div class="woo-ready-sku">
                    <span><?php echo wp_kses_post($sku) ?></span>
                </div>
            </td>
        ...
        <?php endif; if ( $options['weight']['weight_exist'] ): ?>

        <tr>

            <th><?php echo wp_kses_post($options['weight']['title']); ?></th>
            ...
            <td>
                <div class="woo-ready-weight">
                    <span><?php echo wp_kses_post($weight); ?></span>
                </div>
            </td>
        ...
        <?php endif; if ( $options['dimention']['dimention_exist'] ): ?>

        <tr>

            <th><?php echo wp_kses_post(options['dimention']['title']); ?></th>
        ...
        <?php endif; if ( $options['size']['size_exist'] ): ?>

        <tr>

            <th><?php echo wp_kses_post($options['size']['title']); ?></th>
            ...
            <td>
                <div class="woo-ready-size">
                    <span><?php echo wp_kses_post($size); ?></span>
                </div>
            </td>
        ...
        <?php endif; if ( $options['addtocart']['addtocart_exist'] ): ?>

        <tr>

            <th><?php echo wp_kses_post($options['addtocart']['title']); ?></th>
