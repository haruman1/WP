       ...
       // Notice 
		...
		$this->box_css(
            array(
                ...
                'title'        => esc_html__('Inner Box Date','shopready-elementor-addon'),
		...
		$this->box_css(
            array(
                ...
                'title'        => esc_html__('Inner Box Amount','shopready-elementor-addon'),
		...
		$this->box_css(
            array(
                ...
                'title'        => esc_html__('Inner Box Email','shopready-elementor-addon'),
