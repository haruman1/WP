	...
	if ( $rating_count > 0 ) : ?>
		...
		<div class="woocommerce-product-rating">
			...
			<?php if ( comments_open() ) : ?>
				<?php //phpcs:disable ?>
				<a href="#<?php echo esc_attr($settings['review_form_section']); ?>" class="woocommerce-review-link" rel="nofollow">(<?php printf( _n( '%s customer review', '%s customer reviews', $review_count, 'shopready-elementor-addon' ), '<span class="count">' . esc_html( $review_count ) . '</span>' ); ?>)</a>
				<?php // phpcs:enable ?>
			<?php endif ?>
		</div>
