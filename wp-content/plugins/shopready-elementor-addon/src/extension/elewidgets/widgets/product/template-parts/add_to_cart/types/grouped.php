							...
							if ( ! $grouped_product_child->is_purchasable() || $grouped_product_child->has_options() || ! $grouped_product_child->is_in_stock() ) {
								...
								woocommerce_quantity_input(
									array(
										...
										'input_value' => sanitize_text_field( isset( $_POST['quantity'][ $grouped_product_child->get_id() ] ) ? wc_stock_amount( wc_clean( wp_unslash( $_POST['quantity'][ $grouped_product_child->get_id() ] ) ) ) : ''), // phpcs:ignore WordPress.Security.NonceVerification.Missing
