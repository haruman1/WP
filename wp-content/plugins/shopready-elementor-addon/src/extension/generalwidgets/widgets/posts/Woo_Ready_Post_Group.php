...
class Woo_Ready_Post_Group extends \Shop_Ready\extension\generalwidgets\Widget_Base  {
    ...
    static function content_layout_style(){
        return apply_filters( 'shop_ready_gen_post_groups', [
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .woo__ready__single__post .post__content .post__title' => 'text-align: {{VALUE}};',
                    ],
                ]
            );
    ...
    public function element_ready_post_thumbnail($get_post_id){
        ...
        <?php if ( 'yes' == $settings['show_thumb'] && has_post_thumbnail($get_post_id) ) : ?>
            <div class="post__thumb">
                <a href="<?php echo esc_url(get_the_permalink($get_post_id));?>"><img src="<?php echo esc_url( $thumb_link ) ?>" alt="<?php echo get_the_title($get_post_id); ?>"></a>
            </div>
        <?php endif;
    }
    ...
    public function woo_ready_post_title($get_post_id){
        ...
        <?php if( $settings['show_title'] == 'yes' ):?>
            <h3 class="post__title"><a href="<?php echo esc_url(get_the_permalink($get_post_id));?>"><?php echo wp_trim_words( get_the_title($get_post_id), $settings['title_length'], '' ); ?></a></h3>
        <?php endif;
    }
            ...
            <div class="post__btn">
                <?php if ( !empty( $settings['readmore_icon'] ) ) : ?>
                    <?php if( 'right'  == $settings['readmore_icon_position'] ) : ?>
                        <a class="readmore__btn" href="<?php echo esc_url(get_the_permalink($get_post_id));?>"><?php echo esc_html__( $settings['read_more_txt'], 'shopready-elementor-addon' );?> <i class="readmore_icon_right <?php echo esc_attr( $settings['readmore_icon'] ) ?>"></i></a>
                    <?php elseif( 'left'  == $settings['readmore_icon_position'] ): ?>
                        <a class="readmore__btn" href="<?php echo esc_url(get_the_permalink($get_post_id));?>"><i class="readmore_icon_left <?php echo esc_attr( $settings['readmore_icon'] ) ?>"></i><?php echo esc_html__( $settings['read_more_txt'], 'shopready-elementor-addon' );?></a>
                    <?php endif; ?>
                <?php else: ?>
                    <a class="readmore__btn" href="<?php echo esc_url(get_the_permalink($get_post_id));?>"><?php echo esc_html__( $settings['read_more_txt'], 'shopready-elementor-addon' );?></a>
                <?php endif; ?>
            </div>
        <?php endif;
    }
