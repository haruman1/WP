...
(function($) {
    ...
    * filter component & module
    ...
    $('#element-ready-modules-button-sbt').on('click',function(e){
        ...
        er_modules_form_submits(old,$(this));
    });
    ...
    $(document).off().on('click','input.element-ready-modules-all-js-enable', function() {
        ...
        $.each(filter_col, function() {
            ...
            if (!that_widgets.attr('readonly')) {
                that_widgets.prop('checked', true)
            }

        });
        
        let old = $( this ).parent().clone();
        let that = $( this ).parent();
      
        that.text('saving...');

        er_modules_form_submits(old,that);
    ...
    $('#quomodo-components-all-disable').on('click', function() {
        ...
        er_compononet_form_submits(old,$(this));
    });
            ...
            success: function(response) {
               ...
               $('body').append('<div class="show element-ready--lite-snackbar" id="element-ready--lite-snackbar">'+response.data+'</div>');  
                        ...
                        setTimeout(function(){ 
                            ...
                            if(button !=null && this_button !=null){
                                this_button.html(button.html());
                            }
                        }, 3000);
