<?php
    ...
    $download_cats             = get_the_term_list( get_the_ID(), 'download_category', '', _x(' , ', '', 'element-ready' ), '' );
...
<?php
    ...
    $single_sales_count    = $single_sales_count > 1 ? $single_sales_count . '<span class="sale__count__text">'.esc_html__( ' Sales', 'element-ready' ).'</span>'  : $single_sales_count . '<span class="sale__count__text">'.esc_html__( ' Sale', 'element-ready' ).'</span>';
    ...
    if ( $price_amount == "0.00" ) {
        $separate_price = esc_html__( 'Free', 'element-ready' );
    ...
    $separate_variable_button = '<a href="'.get_the_permalink().'" target="_blank" class="price__variable__button">'.esc_html__( 'View Details', 'element-ready' ).'</a>';
    ...
    <div class="single__donwload__product">
                ...
                <div class="download__preview__button__block">
                    ...
                    <!-- DWONLOAD BUTTON CUSTOM TEXT -->
                        <div class="download__custom__preview__link">
                            <a href="<?php echo esc_url( get_the_permalink() ); ?>" target="<?php echo esc_attr__( '_blank', 'element-ready' ); ?>"><?php echo esc_html($live_preview_text); ?></a>
                        </div>
                        ...
                        <?php else : ?>
                            ...
                            <?php if( edd_has_variable_prices( get_the_ID() ) ) : ?>
                                <a class="price__variable__modl__button" href="#<?php echo esc_attr( $donwload_unique_slug ); ?>" data-lity>
                                    <?php esc_html_e('View Prices','element-ready'); ?>
                                </a>
                                ...
                                <div id="<?php echo esc_attr($donwload_unique_slug); ?>" class="download__modal__popup__overlay lity-hide">
                                    <div class="donwload__purchase__popup">
                                        <div class="modal__header ">
                                            <h4><?php esc_html_e('Choose Your Desired Options','element-ready'); ?></h4>
        ...
        <div class="download__product__details">
            ...
            <div class="download__top__meta">
                <span class="download__metadata metadata__author"><?php esc_html_e('By ','element-ready'); ?>
                ...
                <span class="download__metadata metadata__category"><?php esc_html_e('In ','element-ready'); ?><?php echo wp_kses_post( $download_cats ); ?></span>
                <?php endif; ?>
            </div>
