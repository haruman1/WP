...
class Element_Ready_page_cookie {
    ...
    public function after_section_end( \Elementor\Core\DocumentTypes\Page $page , $args ){
        ...
        $page->start_controls_section(
            'header_section',
            [
                'label' => esc_html__( 'Cookie Consent', 'element-ready' ),
        ...
        $page->add_control(
         ...
         $page->add_control(
                'eready_cookie_consent_title', [
                    ...
                    'default'     => esc_html__( 'Explore more' , 'element-ready' ),
                    'label_block' => true,
            ...
            $page->add_control(
                'eready_cookie_consent_message', [
                    ...
                    'default'     => esc_html__( 'This website uses cookies to ensure you get the best experience on our website.' , 'element-ready' ),
                    'label_block' => true,
            ...
            $page->add_control(
                'eready_cookie_more_info_lavel', [
                    'label'       => esc_html__( 'More Info Label', 'element-ready' ),
                    'type'        => \Elementor\Controls_Manager::TEXT,
                    'default'     => esc_html__( 'More information' , 'element-ready' ),
                    'label_block' => true,
            ...
            $page->add_control(
                'eready_cookie_lavel', [
                    'label'       => esc_html__( 'accept Btn Label', 'element-ready' ),
                    'type'        => \Elementor\Controls_Manager::TEXT,
                    'default'     => esc_html__( 'Accept Cookie' , 'element-ready' ),
                    'label_block' => true,
            ...
            $page->add_control(
                'eready_cookie_advancedlavel', [
                    'label'       => esc_html__( 'advanced Btn Label', 'element-ready' ),
                    'type'        => \Elementor\Controls_Manager::TEXT,
                    'default'     => esc_html__( 'Customise Cookies' , 'element-ready' ),
                    'label_block' => true,
            ...
            $page->add_control(
                ...
                [
                    'label' => esc_html__( 'Unchecked', 'element-ready' ),
                    'type' => \Elementor\Controls_Manager::SELECT,
                    'default' => 'no',
                    'show_label' => true,
                    'options' => [
           ...
           $page->add_control(
                'eready_cookie_consent_expire', [
                    'label'       => esc_html__( 'Expire', 'element-ready' ),
                    'type'        => \Elementor\Controls_Manager::NUMBER,
                    'default'     => 60,
                    'description' => esc_html__('Select tume type from below option','element-ready'),
                    'label_block' => false,
            ...
            $page->add_control(
                ...
                [
                    'label' => esc_html__( 'Time Type', 'element-ready' ),
                    'type' => \Elementor\Controls_Manager::SELECT,
                    'default' => 'sec',
                    'show_label' => true,
                    'options' => [

                        'day'  => esc_html__( 'Days', 'element-ready' ),
                        'min'  => esc_html__( 'Minutes', 'element-ready' ),
                        'hour' => esc_html__( 'Hour', 'element-ready' ),
                        'sec'  => esc_html__( 'Seconds', 'element-ready' ),
           ...
           $page->add_control(
            'eready_cookie_consent_delay', [
                'label'       => esc_html__( 'Delay', 'element-ready' ),
                'type'        => \Elementor\Controls_Manager::NUMBER,
                'default'     => 2000,
        ...
        $page->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Cookie Consent Title', 'element-ready' ),
        ...
        $page->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Cookie Message', 'element-ready' ),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $page->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Cookie Accept button', 'element-ready' ),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $page->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Advanced button', 'element-ready' ),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
            ...
            $page->add_control(
                ...
                [
                    ...
                    'show_label' => true,
                    'options' => [
                        'block'  => esc_html__( 'Yes', 'element-ready' ),
        ...
        $page->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Cookie Consent Wrapper', 'element-ready' ),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
