...
class Element_Ready_Effects {
    ...
    public static function add_controls_section( Element_Base $element ) {
        $element->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Element Effects', 'element-ready' ),
    ...
    public static function add_floating_effects( Element_Base $element ) {
        $element->add_control(
            ...
            [
                'label'              => esc_html__( 'Floating Effects', 'element-ready' ),
        ...
        $element->add_control(
            ...
            [
                'label'              => esc_html__( 'Translate', 'element-ready' ),
        ...
        $element->start_popover();
            $element->add_control(
                ...
                [
                    'label'   => esc_html__( 'Translate X', 'element-ready' ),
                    ...
                    'labels' => [
                        esc_html__( 'From', 'element-ready' ),
                        esc_html__( 'To', 'element-ready' ),
                    ],
                    'scales'    => 1,
                    'handles'   => 'range',
                    'condition' => [
            ...
            $element->add_control(
                ...
                [
                    'label'   => esc_html__( 'Translate Y', 'element-ready' ),
                    'type'    => Controls_Manager::SLIDER,
                    'default' => [
                        'sizes' => [
                            'from' => 0,
        ...
        $element->start_popover();
            ...
            $element->add_control(
                ...
                [
                    'label'   => esc_html__( 'Rotate Z', 'element-ready' ),
                    'type'    => Controls_Manager::SLIDER,
                    'default' => [
                        'sizes' => [
                            'from' => 0,
        ...
        $element->start_popover();
            $element->add_control(
                ...
                [
                    'label'   => esc_html__( 'Scale X', 'element-ready' ),
                    'type'    => Controls_Manager::SLIDER,
                    'default' => [
                        'sizes' => [
                            'from' => 1,
            ...
            $element->add_control(
                ...
                [
                    'label'   => esc_html__( 'Scale Y', 'element-ready' ),
                    'type'    => Controls_Manager::SLIDER,
                    'default' => [
                        'sizes' => [
                            'from' => 1,
    ...
    public static function add_css_effects( Element_Base $element ) {
        $element->add_control(
            ...
            [
                'label'        => esc_html__( 'CSS Transform', 'element-ready' ),
                'type'         => Controls_Manager::SWITCHER,
                'return_value' => 'yes',
            ]
        );
        ...
        $element->add_control(
            ...
            [
                'label'        => esc_html__( 'Skew', 'element-ready' ),
                'type'         => Controls_Manager::POPOVER_TOGGLE,
                'return_value' => 'yes',
                'condition'    => [
                    'element_ready_transform_fx' => 'yes',
        ...
        $element->start_popover();
            $element->add_responsive_control(
                ...
                [
                    'label'      => esc_html__( 'Skew X', 'element-ready' ),
                    'type'       => Controls_Manager::SLIDER,
                    'size_units' => ['deg'],
                    'range'      => [
                        'px' => [
            ...
            $element->add_responsive_control(
                ...
                [
                    'label'      => esc_html__( 'Skew Y', 'element-ready' ),
                    'type'       => Controls_Manager::SLIDER,
                    'size_units' => ['deg'],
                    'range'      => [
                        'px' => [
    ...
    public static function add_tilt_effects( Element_Base $element ) {
        $element->add_control(
            ...
            [
                'label'        => esc_html__( 'Tilt Effect', 'element-ready' ),
                'type'         => Controls_Manager::SWITCHER,
                'return_value' => 'yes',
            ]
        );
        $element->add_control(
            'tilt_maxTilt',
            [
                'label'      => esc_html__( 'Max Tilt', 'element-ready' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range'      => [
                    'px' => [
        ...
        $element->add_control(
            'tilt_perspective',
            [
                'label'      => esc_html__( 'Perspective', 'element-ready' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range'      => [
                    'px' => [
