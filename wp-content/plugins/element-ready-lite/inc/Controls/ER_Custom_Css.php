...
class ER_Custom_Css {
	...
	public static function add_controls_section($element, $section_id, $args) {
		...
		if ($section_id == 'section_custom_css_pro') {
			...
			$element->start_controls_section(
				...
				[
					'label' => esc_html__( 'Custom CSS (ER)', 'element-ready' ),
			...
			$element->add_control(
				'er_custom_css_title',
				[
					'raw'  => esc_html__( 'Add your own custom CSS here (element ready)', 'element-ready' ),
			...
			$element->add_control(
				...
				[
					'raw' => esc_html__( 'Use "selector" to target wrapper element. Examples:<br>selector {color: red;} // For main element<br>selector .child-element {margin: 10px;} // For child element<br>.my-class {text-align: center;} // Or use any custom selector', 'element-ready' ),
					'type' => Controls_Manager::RAW_HTML,
	...
	public function enqueue_editor_scripts() {
		wp_enqueue_script('editor-support-js', ELEMENT_READY_ROOT_JS . 'editor-support.js', array('jquery',''), '', true);
	}
