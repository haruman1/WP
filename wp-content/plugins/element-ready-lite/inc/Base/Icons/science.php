...
class Element_Ready_Add_Science_Icons {
    ...
    public function __construct() { 
		add_action( 'elementor/editor/after_enqueue_styles', [ $this, 'element_ready_enqueue_science' ] );
		add_action( 'elementor/frontend/after_enqueue_styles', [ $this, 'element_ready_enqueue_science' ] );    
	...
	public function element_ready_elementor_science_setup( $tabs = array()){
		...
		$tabs['science'] = array(
			'name'          => 'science',
			'label'         => esc_html__( 'Science Icons', 'element-ready' ),
			'labelIcon'     => 'science-014-planets',
			'prefix'        => '',
			'displayPrefix' => 'science',
			'url'           => ELEMENT_READY_ROOT_ICON . 'science/science.css',
			'icons'         => $new_icons,
			'ver'           => '1.0.0',
		);
		return $tabs;
