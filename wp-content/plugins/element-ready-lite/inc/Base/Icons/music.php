...
class Element_Ready_Add_Music_Icons {
    ...
    public function __construct() { 
		add_action( 'elementor/editor/after_enqueue_styles', [ $this, 'element_ready_enqueue_music' ] );
		add_action( 'elementor/frontend/after_enqueue_styles', [ $this, 'element_ready_enqueue_music' ] );    
	...
	public function element_ready_elementor_music_setup( $tabs = array()){
		...
		$tabs['music'] = array(
			'name'          => 'music',
			'label'         => esc_html__( 'Music Icons', 'element-ready' ),
			'labelIcon'     => 'music-011-music',
			'prefix'        => '',
			'displayPrefix' => 'music',
			'url'           => ELEMENT_READY_ROOT_ICON . 'music/music.css',
			'icons'         => $new_icons,
			'ver'           => '1.0.0',
		);
		return $tabs;
