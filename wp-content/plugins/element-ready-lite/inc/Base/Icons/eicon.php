...
class Element_Ready_Add_Eicon_Icons {
    ...
    public function __construct() { 
		add_action( 'elementor/editor/after_enqueue_styles', [ $this, 'element_ready_enqueue_eicon' ] );
		add_action( 'elementor/frontend/after_enqueue_styles', [ $this, 'element_ready_enqueue_eicon' ] );    
	...
	public function element_ready_elementor_eicon_setup( $tabs = array()){
		...
		$tabs['eicon'] = array(
			'name'          => 'eicon',
			'label'         => esc_html__( 'Elementor Icons', 'element-ready' ),
			'labelIcon'     => 'eicon-elementor',
			'prefix'        => '',
			'displayPrefix' => 'eicon',
			'url'           => ELEMENT_READY_ROOT_ICON . 'eicons/eicons.css',
			'icons'         => $new_icons,
			'ver'           => '1.0.0',
		);
		return $tabs;
