...
class Element_Ready_Add_Medical_Icons {
    ...
    public function __construct() { 
		add_action( 'elementor/editor/after_enqueue_styles', [ $this, 'element_ready_enqueue_medical' ] );
		add_action( 'elementor/frontend/after_enqueue_styles', [ $this, 'element_ready_enqueue_medical' ] );    
	...
	public function element_ready_elementor_medical_setup( $tabs = array()){
		...
		$tabs['medical'] = array(
			'name'          => 'medical',
			'label'         => esc_html__( 'Medical Icons', 'element-ready' ),
			'labelIcon'     => 'medical-020-first-aid-kit',
			'prefix'        => '',
			'displayPrefix' => 'medical',
			'url'           => ELEMENT_READY_ROOT_ICON . 'medical/medical.css',
			'icons'         => $new_icons,
			'ver'           => '1.0.0',
		);
		return $tabs;
