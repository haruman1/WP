...
class Element_Ready_Add_Education_Icons {
    ...
    public function __construct() { 
		add_action( 'elementor/editor/after_enqueue_styles', [ $this, 'element_ready_enqueue_education' ] );
		add_action( 'elementor/frontend/after_enqueue_styles', [ $this, 'element_ready_enqueue_education' ] );    
	...
	public function element_ready_elementor_education_setup( $tabs = array()){
		...
		$tabs['education'] = array(
			'name'          => 'education',
			'label'         => esc_html__( 'Education Icons', 'element-ready' ),
