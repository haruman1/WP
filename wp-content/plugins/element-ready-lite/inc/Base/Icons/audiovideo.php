...
class Element_Ready_Add_Audiovideo_Icons {
    ...
    public function __construct() { 
		add_action( 'elementor/editor/after_enqueue_styles', [ $this, 'element_ready_enqueue_audiovideo' ] );
		add_action( 'elementor/frontend/after_enqueue_styles', [ $this, 'element_ready_enqueue_audiovideo' ] );    
	...
	public function element_ready_elementor_audiovideo_setup( $tabs = array()){
		...
		$tabs['audiovideo'] = array(
			'name'          => 'audiovideo',
			'label'         => esc_html__( 'Audiovideo Icons', 'element-ready' ),
			'labelIcon'     => 'audiovideo-025-rgb',
			'prefix'        => '',
			'displayPrefix' => 'audiovideo',
			'url'           => ELEMENT_READY_ROOT_ICON . 'audiovideo/audiovideo.css',
			'icons'         => $new_icons,
			'ver'           => '1.0.0',
		);
		return $tabs;
