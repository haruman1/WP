      ...
      if( 
          ...
          && isset($_REQUEST['download_id']) 
                ...
                if( $product->get_price() == 0 || $product->get_price() =='' ) {
                    ...
                    \WC_Download_Handler::download( $product->get_file_download_path( filter_var(sanitize_text_field($_REQUEST['download_id']), FILTER_SANITIZE_STRING)  ),sanitize_text_field($_REQUEST['product_id']) );
                }
         ...
         if( 
          ...
          && isset($_REQUEST['download_id']) 
               ...
               \WC_Download_Handler::download( $product->get_file_download_path( filter_var($_REQUEST['download_id'], FILTER_SANITIZE_STRING)  ),sanitize_text_field($_REQUEST['product_id']) );
