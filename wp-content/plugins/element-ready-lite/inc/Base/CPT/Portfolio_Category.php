...
class Portfolio_Category extends Custom_Taxonomy
{
	...
	public function register() {
        $this->name = esc_html__('Portfolio Categories', 'element-ready');
    	add_action( 'init', array( $this, 'create_taxonomy' ) );
    }

    public function create_taxonomy(){
        $this->init('portfolio_category', esc_html__('Portfolio Category','element-ready'), esc_html__('Portfolio Category','element-ready'), 'portfolio');
