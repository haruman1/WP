...
class SignIn extends BaseController
{
    ...
    function form_validate($data){
        ...
        if(isset($data['password']) && $data['password'] == ''){
            $this->errors = esc_html__('Password should not empty','element-ready');
            $_SESSION["element_ready_quomodo_login_msg"]['valid_email'] = esc_html__('Password should not empty','element-ready');
        } 
    ...
    public function login($data){
        ...
        if ( is_wp_error( $user ) ) {
            ...
            $this->success = esc_html__('Login Success','element-ready'); 
