...
class Element_Ready_Vertical_Menu extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'ER Vartical Menu', 'element-ready' );
    }
	...
	protected function register_controls() { 
        ...
        $this->start_controls_section(
			...
			[
				'label' => __( 'Vertical Menu Options', 'element-ready' ),
			]
		);
        ...
        $this->add_control(
            ...
            [
                'label' => __('Layout Type', 'element-ready'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'always-open' => __('Always Open', 'element-ready'),
                    'open-close'  => __('Open to Close', 'element-ready'),
                    'close-open'  => __('Close to Open', 'element-ready'),
                ],
                'default' => 'always-open',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Category Heading', 'element-ready'),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('All Categories', 'element-ready'),
                'dynamic' => ['active' => true],
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Vertical Menu Content', 'element-ready'),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Tab Title', 'element-ready'),
                'dynamic' => ['active' => true],
                'condition' => [
        ...
        $repeater->add_control(
            'er_source_content',
            [
                'label' => __('Content Source', 'element-ready'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'wc_cat'   => __('WooCommmerce category', 'element-ready'),
                    'blog_cat' => __('Blog Category', 'element-ready'),
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__('Product Category', 'element-ready'),
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__('Blog Category', 'element-ready'),
                'type' => Controls_Manager::SELECT2,
                'multiple' => false,
        ...
        $repeater->add_control(
            ...
            [
                'label' => __('Content Type', 'element-ready'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'content' => __('Content', 'element-ready'),
                    'template' => __('Saved Templates', 'element-ready'),
                ],
                'default' => 'content',
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'label' => __('Choose Template', 'element-ready'),
                'type' => Controls_Manager::SELECT,
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__('Tab Content', 'element-ready'),
        ...
        $this->add_control(
            ...
            [
                ...
                'seperator' => 'before',
                'default' => [
                    ['tab_title' => esc_html__('Fashion Accesories', 'element-ready')],
                    ['tab_title' => esc_html__('Consumer Electronics', 'element-ready')],
                    ['tab_title' => esc_html__('Phone & Telecom', 'element-ready')],
                ],
        ...
        $this->box_css(
            [
                'title'          => esc_html__('Vertical Menu Container','element-ready'),
        ...
        $this->box_css(
            [
                'title'          => esc_html__('Heading Container','element-ready'),
        ...
        $this->text_minimum_css(
            [
                'title'          => esc_html__('Heading Icon','element-ready'),
        ...
        $this->text_minimum_css(
            [
                'title'          => esc_html__('Heading Title','element-ready'),
        ...
        $this->box_css(
            [
                'title'          => esc_html__('Menu Box','element-ready'),
        ...
        $this->box_css(
            [
                'title'          => esc_html__('Menu Item Box','element-ready'),
        ...
        $this->box_css(
            [
                'title'          => esc_html__('Menu Icon Box','element-ready'),
        ...
        $this->text_minimum_css(
            [
                'title'          => esc_html__('Menu Icon','element-ready'),
        ...
        $this->text_minimum_css(
            [
                'title'          => esc_html__('Menu Title','element-ready'),
        ...
        $this->text_minimum_css(
            [
                'title'          => esc_html__('After Title Icon','element-ready'),
        ...
        $this->box_css(
            [
                'title'          => esc_html__('Sub Menu Box','element-ready'),
        ...
        $this->text_minimum_css(
            [
                'title'          => esc_html__('Sub Menu Style','element-ready'),
	...
	protected function render() {
        ...
        $this->add_render_attribute(
            ...
            [
                ...
                'data-layout' => $settings['woo_ready_category_vertical_menu_layout_type'] ,
        ...
        <section <?php echo $this->get_render_attribute_string( 'woo_ready_product_vertical_menu_wrapper' )?>>
            ...
            <div class="element-ready-header-box">
                <h3 class="element-ready-widget-title">
                    ...
                    <span class="vertical-category-menu-title"><?php echo $settings['woo_ready_category_vertical_heading_menu_title'] ?></span>
                </h3>
