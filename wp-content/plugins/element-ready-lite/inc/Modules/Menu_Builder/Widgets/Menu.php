       ...
       <!--====== Header START ======-->
        <?php if($settings['menu_style'] == 'style1'): ?>
            ...
            <?php
                ...
                if( !\Elementor\Plugin::$instance->editor->is_edit_mode() ){
                    ...
                    wp_deregister_script( 'stellarnav' );
                    wp_deregister_style( 'stellarnav' );
                
                    wp_deregister_style( 'er-round-menu' );
                    wp_deregister_style( 'stellarnav' );
                    wp_deregister_style( 'er-standard-round' );
                    wp_deregister_style( 'er-offcanvas-slide-menu' );
                    wp_deregister_style( 'er-standard-offcanvas' );
                    wp_deregister_style( 'er-standard-5-menu' );
                    wp_deregister_style( 'er-standard-menu' );
        ...
        <?php if($settings['menu_style'] == 'style2'): ?>
            ...
            <?php
                  ...
                  if( !\Elementor\Plugin::$instance->editor->is_edit_mode() ){
                    ...
                    wp_deregister_style( 'stellarnav' );
                    wp_deregister_style( 'er-standard-round' );
                    wp_deregister_style( 'er-offcanvas-min-menu' );
                    wp_deregister_style( 'er-standard-offcanvas' );
                    wp_deregister_style( 'er-standard-5-menu' );
                    wp_deregister_style( 'er-standard-menu' );
        ...
        <?php if($settings['menu_style'] == 'style3'): ?>
            ...
            <?php
                ...
                wp_deregister_script( 'element-ready-menu-frontend-script' );
