...
<div class="er-thankyou-container"> 
     ...
     <div class="er-order-details">
          <div class="er-product-label label"> <?php echo esc_html__('Product','element-ready'); ?></div> 
          <div class="er-product-name er-value"><?php echo esc_html($name); ?> </div> 
     </div>

     <div class="er-order-details">
      
      <div class="er-product-total-label label"> <?php echo esc_html__('Amount','element-ready'); ?> </div> 
    ...
    <div class="er-order-details">
      ...
      <div class="er-product-invoice-label label"> <?php echo esc_html__('Invoice Number','element-ready'); ?> </div> 
      <div class="er-product-invoice er-value"> <?php echo esc_html($order_id); ?> </div> 

    </div>
    <div class="er-order-details">
      
      <div class="er-product-email-label label"> <?php echo esc_html__('Email','element-ready'); ?> </div> 
