...
class Element_Ready_Countdown_Widget extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'ER Coundown Lite', 'element-ready' );
    }
   ...
   public function get_script_depends(){
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                'label'       => __( 'Day', 'element-ready' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
                'default'     => __( 'days', 'element-ready' ),
                'label_block' => true,
        ...
        $this->add_control(
            ...
            [
                'label'       => __( 'Hour', 'element-ready' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
                'default'     => __( 'Hour', 'element-ready' ),
                'label_block' => true,
        ...
        $this->add_control(
            ...
            [
                'label'       => __( 'Min', 'element-ready' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
                'default'     => __( 'Min', 'element-ready' ),
                'label_block' => true,
        ...
        $this->add_control(
            ...
            [
                'label'       => __( 'Second', 'element-ready' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
                'default'     => __( 'Sec', 'element-ready' ),
                'label_block' => true,
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Countdown Date', 'element-ready' ),
        ...
        $this->box_css(
            [
                'title'          => esc_html__( 'Wrapper', 'element-ready' ),
        ...
        $this->text_css(
            [
                'title'          => esc_html__( 'Word', 'element-ready' ),
    ...
    ?>       
        ...
        <div class="element--ready--lite--countdown"
            ...
            data-date="<?php echo $countdown_date; ?>"
            data-time="<?php echo $countdown_time; ?>">
