...
class ER_Shopping_Cart_Coupon extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'ER Woo Coupon form', 'element-ready-lite' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'show_coupon_heading',
            [
                'label'        => esc_html__( 'Coupon heading?', 'shop-ready' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'yes', 'shop-ready' ),
                'label_off'    => esc_html__( 'yes', 'shop-ready' ),
                'return_value' => 'yes',
                'default'      => '',
            ]
        );
        ...
        <form class="checkout_coupon woocommerce-form-coupon" method="post">
            <div class="element-ready--coupon-row-wrapper">
                ...
                <p class="form-row form-row-first woo-ready-coupon-col">
                    <input type="text" name="coupon_code" class="input-text" placeholder="<?php esc_attr_e( 'Coupon code', 'element-ready-lite' ); ?>" id="coupon_code" value="" />
                </p>

                <p class="form-row form-row-last wready-coup-btn-col">
                    <button type="submit" class="button" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'element-ready-lite' ); ?>"><?php esc_html_e( 'Apply coupon', 'element-ready-lite' ); ?></button>
                </p>
            </div>
        </form>
        <?php
