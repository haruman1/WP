...
class jupiter_Widget_Product extends Widget_Base {
	...
	public function get_title() {
		return __( 'WC Product', 'jupitercore' );
	}
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'product_content',
            [
                'label' => __( 'WC Products', 'jupitercore' ),
            ]
        );
        ...
        $this->add_control(
            'slider_on',
            [
                'label'         => __( 'Slider On?', 'jupitercore' ),
        ...
        $this->start_controls_section(
            'product_content_option',
            [
                'label' => __( 'Product Option', 'jupitercore' ),
            ]
        );
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Product Categories', 'jupitercore' ),
                    'type' => Controls_Manager::SELECT2,
                    'label_block' => true,
                    'multiple' => true,
                    'options' => jupiter_get_taxonomies('product_cat'),
                ]
            );
            ...
            $this->add_control(
                'show_category',
                [
                    'label' => esc_html__( 'Show Category', 'jupitercore' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'yes',
                ]
            ...
            $this->add_control(
                'product_imagesize',
                [
                    'label' => esc_html__( 'Image Size', 'jupitercore' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'large',
                    'options' => [
                        'thumbnail'          => esc_html__('Thumbnail','jupitercore'),
                        'medium'          => esc_html__('Medium','jupitercore'),
                        'large'          => esc_html__('Large','jupitercore'),
                        'full'          => esc_html__('Full','jupitercore'),
                    ],
                    'condition' => [
                        'show_thumb' => 'yes',
                    ]
            ...
            $this->add_control(
             ...
             $this->add_control(
                'show_price',
                [
                    'label' => esc_html__( 'Show Price', 'jupitercore' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'yes',
                ]
        ...
        $this->start_controls_section(
            'jupitercore_product_area_style_section',
            [
        ...
        $this->add_responsive_control(
            'product_column_margin',
            [
                'label' => __( 'Margin', 'jupitercore' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .jupitercore-product-grid .product_item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' =>'before',
            ]
        );        
        $this->add_responsive_control(
            'product_column_padding',
            [
                'label' => __( 'Padding', 'jupitercore' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .jupitercore-product-grid .product_item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' =>'before',
            ]
        );        
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jupitercore-product-grid .product_item' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
        $this->end_controls_section();
        $this->start_controls_section(
            'jupitercore_product_box_style_section',
            [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .jupiter_posts_carousel .product_item .product-box' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' =>'before',
            ]
        ); 
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .jupiter_posts_carousel .product_item .product-box' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' =>'before',
            ]
        ); 
        $this->add_group_control(
            ...
            [
                'name' => 'jupiter_product_border',
                'label' => __( 'Border', 'jupitercore' ),
                'selector' => '{{WRAPPER}} .jupiter_posts_carousel .product-box',
            ]
        );
        $this->add_responsive_control(
            'jupiter_product_radius',
            [
                'label' => esc_html__( 'Border Radius', 'jupitercore' ),
                'type' => Controls_Manager::DIMENSIONS,
                'selectors' => [
                    '{{WRAPPER}} .jupiter_posts_carousel .product-box' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'jupiter_product_box_shadow',
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'jupiter_product_box_background',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .jupiter_posts_carousel .product-box' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_section(); 
        ...
        $this->start_controls_section(
            'product_slider_title_style_section',
            [
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'=>'#151D41',
                    'selectors' => [
                        '{{WRAPPER}} .jupiter_posts_carousel .product-box .product_content .title a' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'=>'#8A19FA',
                    'selectors' => [
                        '{{WRAPPER}} .jupiter_posts_carousel .product-box .product_content .title a:hover' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .jupiter_posts_carousel .product-box .product_content .title',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .jupiter_posts_carousel .product-box .product_content .title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .jupiter_posts_carousel .product-box .product_content .title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            'product_cats_style_section',
            [
                'label' => __( 'Category', 'jupitercore' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
            $this->add_control(
                ...
                [
                    ...
                    'default'=>'#9fa6be',
                    'selectors' => [
                        '{{WRAPPER}} .product-box .product-header .category a' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'=>'#8A19FA',
                    'selectors' => [
                        '{{WRAPPER}} .product-box .product-header .category a:hover' => 'color: {{VALUE}}'
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __( 'Typography', 'jupitercore' ),
                    'selector' => '{{WRAPPER}} .product-box .product-header .category a',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .product-box .product-header .category' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .product-box .product-header .category' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'=>'#9fa6be',
                    'selectors' => [
                        '{{WRAPPER}} .product-box .product_content .price-text .woocommerce-Price-amount' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __( 'Typography', 'jupitercore' ),
                    'selector' => '{{WRAPPER}} .product-box .product_content .price-text .woocommerce-Price-amount',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .product-box .product_content .price-text' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .product-box .product_content .price-text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            'box_sale_section',
            [
                'label' => __( 'Sale', 'jupitercore' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        
        $this->start_controls_tabs('box_sale_style_tab');
        
        $this->start_controls_tab( 'box_sale_normal',
			[
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __( 'Typography', 'jupitercore' ),
                'selector' => '{{WRAPPER}} .product-box .product-image .sale-flash',
            ]
        );
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .product-box .product-image .sale-flash' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);        
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .product-box .product-image .sale-flash' => 'height: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .product-box .product-image .sale-flash' => 'line-height: {{SIZE}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_control(
            ...
            [
				...
				'default' => '#8A19FA',
                'selectors' => [
                    '{{WRAPPER}} .product-box .product-image .sale-flash' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
         ...
         $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .product-box .product-image .sale-flash' => '{{VALUE}};',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .product-box .product-image .sale-flash' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' =>'before',
            ]
        );
        $this->add_group_control(
            ...
            [
                'name' => 'sale_border',
                'label' => __( 'Border', 'jupitercore' ),
                'selector' => '{{WRAPPER}} .product-box .product-image .sale-flashs',
            ]
        );
        $this->add_responsive_control(
            'sale_border_radius',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .product-box .product-image .sale-flash' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ]
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .product-box .product-image .sale-flash' => 'transition-duration: {{SIZE}}s',
				],
			]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#ffffff',
                'selectors' => [
                    '{{WRAPPER}} .product-box:hover .product-image .sale-flash' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            Group_Control_Background::get_type(),
            [
                'name' => 'hover_sale_background',
                'label' => __( 'Background', 'jupitercore' ),
                'types' => [ 'classic', 'gradient' ],
                'selector' => '{{WRAPPER}} .product-box:hover .product-image .sale-flash',
            ]
        );
        $this->add_group_control(
            Group_Control_Border::get_type(),
            [
                'name' => 'hover_sale_border',
                'label' => __( 'Border', 'jupitercore' ),
                'selector' => '{{WRAPPER}} .product-box:hover .product-image .sale-flash',
            ]
        );
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'jupiter_product_attr', 'class', 'jupiter_posts_carousel' );
        // Slider options
        if( $settings['slider_on'] == 'yes' ){
            $this->add_render_attribute( 'jupiter_product_attr', 'class', 'jupitercore-carousel-activation' );
            $slider_settings = [
            ...
            $this->add_render_attribute( 'jupiter_product_attr', 'data-settings', wp_json_encode( $slider_settings ) );
        }else {            
            $this->add_render_attribute( 'jupiter_product_attr', 'class', 'jupitercore-product-grid' );
            $this->add_render_attribute( 'jupiter_product_attr', 'class', 'masonrys' );
        }
        // Query
        $args = array(
            'post_type'             => 'product',
        ...
        ?><div <?php echo $this->get_render_attribute_string( 'jupiter_product_attr' ); ?> >
           <?php
    ...
    public function jupitercore_render_loop_content( $contetntstyle = NULL ){
        ...
        if( get_the_post_thumbnail() and $settings['show_thumb'] == true ): ?>
            <div class="product-image"><?php the_post_thumbnail($settings['product_imagesize']); woocommerce_show_product_loop_sale_flash(); ?></div>
        <?php endif; ?>
...
if( class_exists( 'WooCommerce' ) ){  
    Plugin::instance()->widgets_manager->register_widget_type( new jupiter_Widget_Product );
}