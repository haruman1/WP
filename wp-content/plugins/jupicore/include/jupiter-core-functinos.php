...
function jupiter_breadcrumb( $home = 'Home', $separator = ' | ' ){
    // Set variables for later use
    $here_text        = __( 'You are currently here!' );
    $home_link        = home_url('/');
    $home_text        = '<span class="icon"><i class="fal fa-home"></i></span>'.wp_kses_post($home);
    ...
    $breadcrumb_output_link .= '<div class="bread sub-title">';
...
function jupiter_post_share_social(){
        global $post;
        ...
        <div class="social-share">
           <h3 class="share-title" >Social Share</h3>
            <ul>
                <li><a href="<?php echo esc_url($facebookURL); ?>"><i class="fab fa-facebook-f"></i></a></li>
                <li><a href="<?php echo esc_url($twitterURL); ?>"><i class="fab fa-twitter"></i></a></li>
                <li><a href="<?php echo esc_url($linkedinURL); ?>"><i class="fab fa-linkedin-in"></i></a></li>
...
function jupiter_set_post_views($postID) {
    $count_key = 'jupiter_post_views_count';
...
function jupiter_track_post_views ($post_id) {
    if ( !is_single() ) return;
    if ( empty ( $post_id) ) {
        global $post;
        $post_id = $post->ID;    
    }
    jupiter_set_post_views($post_id);
}
add_action( 'wp_head', 'jupiter_track_post_views');
 ...
 * return array
 */
function jupiter_get_taxonomies( $jupiter_texonomy = 'category' ){
    $terms = get_terms( array(
        'taxonomy' => $jupiter_texonomy,
        'hide_empty' => true,
    ));
 ...
 * return array
 */
function jupiter_get_post_types( $args = [] ) {   
    $post_type_args = [
