...
class Instagram_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'instagram', // Base ID
            __('Instagram Feed', 'jupitercore'), // Name
            array( 'description' => __( 'Show Instagram feed to adding this widget.', 'jupitercore' ), ) // Args
        );
    }
    ...
    public function form( $instance ) {
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = __( 'Instagram', 'jupitercore' );
        }
        ...
        ?>
        <p>
        <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:','jupitercore' ); ?></label> 
        <input 
            class="widefat" 
        ...
        <p>
        <label for="<?php echo $this->get_field_id( 'user_id' ); ?>"><?php echo sprintf( __( 'Instagram <a target="_blank" href="%s">User ID</a>:','jupitercore' ),'https://codeofaninja.com/tools/find-instagram-user-id'); ?></label> 
        <input 
            class="widefat" 
        ...
        <p>
        <label for="<?php echo $this->get_field_id( 'access_token' ); ?>"><?php echo sprintf( __( 'Instagram <a target="_blank" href="%s">Access Token</a>:','jupitercore' ),'https://instagram.pixelunion.net/'); ?></label> 
        <input 
            class="widefat" 
        ...
        <label for="<?php echo $this->get_field_id( 'total_items' ); ?>"><?php _e( 'Total Photo Show:','jupitercore' ); ?></label> 
        <input 
            class="widefat" 
...
function jupitercore_instagram_widget(){
    register_widget( 'Instagram_Widget' );
}
add_action( 'widgets_init', 'jupitercore_instagram_widget' );